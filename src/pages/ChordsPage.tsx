...
export const ChordsPage = () => {
  const { chords, isShapeVisible, cagedPosition, getRandomChordsOnClick } = useChordSettingsContext();
    ...
    <div className="h-full flex flex-col items-center justify-center">
      <div className="w-screen flex items-center justify-center">
        <div className="flex flex-col items-center gap-5">
          <ChordsList chords={chords} ShapeDecorator={ShapeDecorator} onClick={handleChordsListOnClick} />
          <TimerCue />
          <ChordsSettings />
        </div>
      </div>
